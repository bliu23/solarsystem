...
//referencing http://learningwebgl.com/blog/?p=1253

/*
Create a sphere by slicing it into a bunch of latitude and longitude bands.
The latitude bands should look like slicing a tomato horizontally into pieces.
The longitude bands on the other hand should look like how an orange peels apart; not sliced like the tomato, but all points through the center

We use the intersection of these slices in order to select where our vertices will be.
This is given by:
  x = r sinTheta cosPhi
  y = r cosPhi
  z = r sinTheta sinPhi
...
Declare_Any_Class("Sphere",          // As our shapes get more complicated, we begin using matrices and flow control (including loops) to
  {
    'populate': function (num_bands, radius, using_flat_shading)  // generate non-trivial point clouds and connect them.
    {
      var this_shape = this;
      var numIndices = 0;
